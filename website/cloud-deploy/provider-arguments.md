# ☁️ Provider Arguments: AWS vs GCP vs Linode
...
This document outlines the **pros and cons of cloud providers** for hosting the
MantraOS website and related infrastructure.
...
- **Short-term**: AWS EKS for maturity/integrations. **Mid-term**: Evaluate GCP
- GKE if AWS complexity rises. **Long-term**: Consider Linode LKE if
- simplicity/values dominate.
